...
#include "include/pf_vector.h"
#include "include/pf_kdtree.h"
...
pf_kdtree_t *pf_kdtree_alloc(int max_size)
{
    ...
    self->nodes =
            (pf_kdtree_node_t *) calloc(self->node_max_count,
...
void pf_kdtree_cluster(pf_kdtree_t *self)
{
    ...
    queue_count = 0;
    queue = (pf_kdtree_node_t **) queuecalloc(self->node_count, sizeof(queue[0]));
