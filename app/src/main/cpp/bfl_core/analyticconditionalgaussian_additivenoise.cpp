...
#include "include/analyticconditionalgaussian_additivenoise.h"
...
/// Destructor
    ...
    void
    CondGausAddNoise::AdditiveNoiseMuSet(const Vector3d &mu)
    {
        _additiveNoise_Mu = mu;
    }

    void
    CondGausAddNoise::AdditiveNoiseSigmaSet(const Matrix3d &sigma)
    {
