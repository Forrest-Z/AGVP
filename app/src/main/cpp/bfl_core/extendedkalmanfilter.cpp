...
namespace bfl_core
{
    ...
    void
    ExtendedKalmanFilter::SysUpdate(SystemModel<Eigen::Vector3d> *const sysmodel,
    ...
    void
    ExtendedKalmanFilter::MeasUpdate(MeasurementModel<Eigen::Vector3d,
                                     ...
                                     const Eigen::Vector3d &s)
    {
        ...
        (_mapMeasUpdateVariablesExt_it->second)._R =
                ((AnalyticMeas *) measmodel)->CovarianceGet(s, _x);

        CalculateMeasUpdate(z,
                            (_mapMeasUpdateVariablesExt_it->second)._Z,
                            (_mapMeasUpdateVariablesExt_it->second)._H,
                            (_mapMeasUpdateVariablesExt_it->second)._R);
    }
