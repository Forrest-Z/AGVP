...
/** This class inherits from Pdf Virtual public because of the multiple
  ...
  */
    ...
    class ConditionalPdf : public Pdf<Var>
    {
    public:
        /// Constructor
        /** @param dimension int representing the number of rows of the state
              ...
              the |
          */
        ConditionalPdf(unsigned int dimension = 0,
...
// constructor
    template<typename Var, typename CondArg>
    ConditionalPdf<Var, CondArg>::ConditionalPdf(unsigned int dim,
                                                 unsigned int num_args)
            : Pdf<Var>(dim), _NumConditionalArguments(num_args),
...
//Clone function
    ...
    template<typename Var, typename CondArg>
    inline void
    ConditionalPdf<Var, CondArg>::NumConditionalArgumentsSet(
            unsigned int numconditionalarguments)
    {
