...
#ifndef AGVP_DIJKSTRAEXPANSION_H
#define AGVP_DIJKSTRAEXPANSION_H
...
namespace nav_core
{
    ...
    private:
         ...
         */
        void updateCell(unsigned char *costs, double *potential, int n);
        /** updates the cell at index n */

        double getCost(unsigned char* costs, int n)
        {
            double c = costs[n];
...
#endif //AGVP_DIJKSTRAEXPANSION_H
