...
#ifndef AGVP_COSTMAP_2D_H
#define AGVP_COSTMAP_2D_H
...
namespace costmap_core
{
    ...
    public:
         ...
         * @param  map The costmap to copy
         * @param win_origin_x The x origin (lower left corner) for the window to copy,
         * in meters
         * @param win_origin_y The y origin (lower left corner) for the window to copy,
         * in meters
        ...
        /**
         * @brief  Convert from world coordinates to map coordinates
         * without checking for legal bounds
         * @param  wx The x world coordinate
         * @param  wy The y world coordinate
         * @param  mx Will be set to the associated map x coordinate
         * @param  my Will be set to the associated map y coordinate
         * @note   The returned map coordinates <b>are not guaranteed
         * to lie within the map.</b>
         */
        void worldToMapNoBounds(double wx, double wy, int &mx, int &my) const;

        /**
         * @brief  Convert from world coordinates to map coordinates,
         * constraining results to legal bounds.
         * @param  wx The x world coordinate
         * @param  wy The y world coordinate
         * @param  mx Will be set to the associated map x coordinate
         * @param  my Will be set to the associated map y coordinate
         ...
         */
        void worldToMapEnforceBounds(double wx, double wy,
                                     int &mx, int &my) const;
         ...
         */
        inline void indexToCells(unsigned int index,
        ...
        /**
         * @brief  Will return a pointer to the underlying unsigned char array
         * used as the costmap
         ...
         * @return The x size of the costmap (returns the centerpoint
         * of the last legal cell in the map)
         */
        double getSizeInMetersX() const;

        /**
         * @brief  Accessor for the y size of the costmap in meters
         * @return The y size of the costmap (returns the centerpoint
         * of the last legal cell in the map)
         */
         ...
         */
        bool setConvexPolygonCost(const base_info::bd_Polygon &polygon,
         ...
         * @param polygon_cells Will be set to the cells contained
         * in the outline of the polygon
         */
        ...
        /**
         * @brief  Move the origin of the costmap to a new location....
        ...
        void resetMap(unsigned int x0, unsigned int y0,
    ...
    protected:
         ...
         * @param sm_lower_left_x The lower left x point of the source map
         * to start the copy
         * @param sm_lower_left_y The lower left y point of the source map
         * to start the copy
         * @param sm_size_x The x size of the source map
         * @param  dest_map The destination map
         * @param dm_lower_left_x The lower left x point of the destination map
         * to start the copy
         * @param dm_lower_left_y The lower left y point of the destination map
         * to start the copy
        ...
        void copyMapRegion(data_type *source_map, unsigned int sm_lower_left_x,
                           ...
                           unsigned int sm_size_x, data_type *dest_map,
        ...
        inline void raytraceLine(ActionType at,
